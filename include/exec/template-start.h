...
#define OF_check(result)  if((result<127UL&&result>-128UL)||result==0UL) cpu.OF=0;else cpu.OF=1;
...
#define OF_check(result)  if((result<32767UL&&result>-32768UL)||result==0UL) cpu.OF=0;else cpu.OF=1;

#elif DATA_BYTE == 4
#define SUFFIX l
#define DATA_TYPE uint32_t
#define DATA_TYPE_S int32_t
#define OF_check(result)  if((result<2147483647UL&&result>-2147483648UL)||result==0UL) cpu.OF=0;else cpu.OF=1;

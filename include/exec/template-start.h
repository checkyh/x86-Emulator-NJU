...
#define EX_I(src,imm)     {if ((imm) >> ((1 << 3) - 1)){if (DATA_BYTE==2) src=imm|0x1100;if (DATA_BYTE==4) src=imm|0x11110000;}else{if (DATA_BYTE==2);src=imm&0x0011;if(DATA_BYTE==4) {printf("%x\n",imm ); src=imm&0x00001111;}}}
